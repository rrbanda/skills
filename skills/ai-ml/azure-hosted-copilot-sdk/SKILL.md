...
description: 'Build, deploy, modify GitHub Copilot SDK apps on Azure. MANDATORY when
  ...
  WHEN: copilot SDK, @github/copilot-sdk, copilot-powered app, deploy copilot app,
  add feature, modify copilot app, BYOM, bring your own model, CopilotClient, createSession,
  sendAndWait, azd init copilot. DO NOT USE FOR: general web apps without copilot
  SDK (use azure-prepare), Copilot Extensions, Foundry agents (use microsoft-foundry).'
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
