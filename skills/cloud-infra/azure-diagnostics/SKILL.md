...
description: 'Debug Azure production issues on Azure using AppLens, Azure Monitor,
  ...
  failures, pod pending, crashloop, node not ready, upgrade failures, analyze logs,
  KQL, insights, image pull failures, cold start issues, health probe failures, resource
  health, root cause of errors.'
license: MIT
metadata:
  author: Microsoft
  version: 1.1.2
