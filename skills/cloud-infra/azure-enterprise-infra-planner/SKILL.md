...
description: 'Architect and provision enterprise Azure infrastructure from workload
  ...
  Bicep or Terraform directly (no azd). WHEN: ''plan Azure infrastructure'', ''architect
  Azure landing zone'', ''design hub-spoke network'', ''plan multi-region DR topology'',
  ''set up VNets firewalls and private endpoints'', ''subscription-scope Bicep deployment'',
