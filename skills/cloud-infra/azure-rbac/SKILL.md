...
description: 'Helps users find the right Azure RBAC role for an identity with least
  ...
  what role should I assign, least privilege role, RBAC role for, role to read blobs,
  role for managed identity, custom role definition, assign role to identity, what
  role do I need to grant access, permissions to assign roles.'
license: MIT
metadata:
  author: Microsoft
  version: 1.1.1
