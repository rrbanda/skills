...
description: 'Discovers available Azure OpenAI model capacity across regions and projects.
  ...
  can I deploy, capacity discovery, best region for capacity, multi-project capacity
  search, quota analysis, model availability, region comparison, check TPM availability.
